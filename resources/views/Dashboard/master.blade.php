...
<body>
								...
								<ul class="contacts">
									...
									<li class="active dz-chat-user">
										{{-- <div class="d-flex bd-highlight">
											<div class="img_cont">
												<img src="/dashboard_themes/images/1.jpg" class="rounded-circle user_img" alt=""/>
                ...
                <nav class="navbar navbar-expand">
                    <div class="collapse navbar-collapse justify-content-between">
                        ...
                        <ul class="navbar-nav header-right">
							...
							1</li> 
							{{-- 1<li class="nav-item dropdown notification_dropdown">
				...
				<ul class="metismenu" id="menu">
					...
					<li>
						...
						<a href="/cooperatives">
							...
							<span class="nav-text">Cooperatives</span>
						</a>
						</a>
					</li>
					<li>
                	...
                	<li>
                    	...
                    	<a href="/microcontrollers/index">
							...
							<span class="nav-text">Microcontrollers</span>
						</a>
						</a>
                    </li>
                    <li>
                        ...
                        <a href="/worms/index">
                            ...
                            <span class="nav-text">Worms</span>
						</a>
    					</a>
                    </li>
                    <li>
						<a  href="javascript:void()" aria-expanded="false">
                        <a href="/cooperatives/show">
							<i class="fa fa-users" aria-hidden="true"></i>
							<span class="nav-text">Cooperative Members</span>
						</a>
    					</a>
                    </li>
                    <li>
                    ...
                    <li>
                        ...
                        <a href="/notification">
							...
							<span class="nav-text">Notification
                        	</span>
						</a>
                        </a>
                    </li>
    ...
    ***********************************-->
	...
	<script src="/dashboard_themes/vendor/chart.js/Chart.bundle.min.js"></script>
    <script src="/dashboard_themes/js/custom.min.js"></script>
	<script src="/dashboard_themes/js/deznav-init.js"></script>
	<script src="/dashboard_themes/vendor/bootstrap-datetimepicker/js/moment.js"></script>
