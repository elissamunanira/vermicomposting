            ...
            <div class="container-fluid">
                <div class="page-titles">
					...
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item active"><a href="javascript:void(0)">MicroControllers</a></li>
					</ol>
                                    ...
                                    <table class="table table-sm mb-0 table-responsive-lg text-black" id="bins">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="align-middle pr-7"> Manufacturer</th>
                                                    ...
                                                    <div class="dropdown text-sans-serif">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right border py-0" aria-labelledby="order-dropdown-0">
                                                            <div class="py-2">
                                                                ...
                                                                <a class="dropdown-item" href="/microcontrollers/{{$microcontroller->id}}/show">view</a>
                                                                <div class="dropdown-divider"></div>
                                                                <a class="dropdown-item" href="/microcontrollers/{{$microcontroller->id}}/edit">Edit</a>
                                                                <div class="dropdown-divider"></div>
                                                               <a class="dropdown-item text-danger" href="/microcontrollers/{{$microcontroller->id}}/delete">Delete</a>
